...
with st.sidebar:
    ...
    st.caption("Adjust threshold interactively in *Model Performance + Threshold Simulator* tab.")
...
with tab_perf:
    ...
    st.markdown("### 🎚️ Interactive Fraud Threshold Simulator")

    sim_thresh = st.slider(
        "Fraud Detection Threshold",
        min_value=0.05, max_value=0.95,
        value=st.session_state.active_threshold, step=0.01
    )
    st.session_state.active_threshold = sim_thresh
